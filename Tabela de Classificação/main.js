...
players.push(newPlayer("Shirley"));
players.push(newPlayer("Eder"));
players.push(newPlayer("Eduarda"));
players.push(newPlayer("Amanda"));
players.push(newPlayer("Clarice"));
players.push(newPlayer("Felipe"));
players.push(newPlayer("Arthur"));
printPlayers();